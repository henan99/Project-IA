...
svc = SVC(class_weight='balanced', kernel= 'poly') # higher score but significantly lower recall with class_weight = NONE.
model = GridSearchCV(svc, params4)
model.fit(X_train, y_train)

#%%
# this model gives a recall of 89.9 % !!
model = SVC(C=16.2, kernel='rbf', class_weight='balanced') # balance makes the smaller class more weighted
model.fit(X_train, y_train)
